...
# 导入带有破折号的模块
spec = importlib.util.spec_from_file_location("compare_denovo", "2-compare_denovo.py")
compare_denovo = importlib.util.module_from_spec(spec)
sys.modules["compare_denovo"] = compare_denovo
spec.loader.exec_module(compare_denovo)
